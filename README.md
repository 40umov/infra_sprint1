...
Проект Kittygram даёт возможность пользователям поделиться фотографиями своих любимымих котиков.
...
- отредактировать settings.py: в список ALLOWED_HOSTS добавить внешний IP-адрес вашего сервера, адреса `127.0.0.1` и `localhost` .
...
- установить зависимости frontend приложения, в директории `<ваш проект>/frontend/` выполнить команду: `npm i`
...
- #### https://kittygram40umov.hopto.org/
